...
const urlList = [
  ...
  },
  {
    name: "MSD Manuals",
    url:
      "https://www.msdmanuals.com/home/infections/respiratory-viruses/coronaviruses-and-acute-respiratory-syndromes-covid-19,-mers,-and-sars",
  },
];
...
const HelpfulLinks = (props) => {
  return (
    <div
      className="faq_body"
      style={{
        background: props.isDark ? "#100a22" : "#f7f7f7",
        height: "100vh",
      }}
    >
