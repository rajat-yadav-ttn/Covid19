  ...
  render() {
    ...
    return (
      <nav style={{ background: isDark ? "#1f2244" : "#fff" }}>
        <div className="logo">
          <img
            src={require("../Images/nav/virus.svg")}
            alt="logo"
            className="logo_img"
          />
        ...
        <div className="list_wrap">
          ...
          <button
            ...
            onClick={() =>
              this.props.darkMode(this.props.isDark === false ? true : false)
            }
          >
            {this.props.isDark ? (
              <img src={require("./icons/sun.png")} alt="light" />
            ) : (
